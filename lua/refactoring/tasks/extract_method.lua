...
local function extract_to_region(refactor, target_region)
...
function M.extract_method_to_file(refactor)
    local target_region = utils.get_top_of_file_region(refactor.scope)
    return extract_to_region(refactor, target_region)
end

function M.extract_method(refactor)
    local target_region = utils.region_above_node(refactor.scope)
    return extract_to_region(refactor, target_region)
end
